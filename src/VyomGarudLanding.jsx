  ...
  return (
    <div className="bg-zinc-950 text-white font-['Inter',sans-serif] overflow-x-hidden overflow-y-hidden">
      ...
      <motion.nav
        ...
        style={{
          backgroundColor:
            scrollY > 50 ? 'rgba(9, 9, 11, 0.95)' : 'transparent',
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <motion.p
                ...
                className='text-lg text-zinc-300 leading-relaxed'
              >
                Our mission is to redefine aerial intelligence through
                precision, reliability, and advanced autonomy—empowering defense
                and security operations with technology that never compromises.
              </motion.p>
              <motion.div
                variants={fadeInLeft}
